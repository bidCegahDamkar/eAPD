...
class Admin_model extends CI_Model {
	...
	*/
	...
	public function get_controller($jab_id)
    {
		...
		$this->db->from('master_jabatan');
        $this->db->select('master_controller.controller, master_controller.config');
	...
	public function hard_delete($nama_table, $id_table, $id)
	{
	...
	*/
	...
	/*public function get_ajax($selectStrList, $tableName, $resultType, $whereArr=null, $likeArr=null, $joinArr=null, $orderArr=null, $limitArr=null, $search='', $search_columns=[], $or_likeArr=null )
    {
        $this->db->select($selectStrList);
		$this->db->from($tableName);
		if(! is_null($whereArr)){
	...
	public function get_ajax($selectStrList, $tableName, $resultType, $whereArr=null, $likeArr=null, $joinArr=null, $orderArr=null, $limitArr=null, $search='', $search_columns=[], $or_whereArr=null )
    {
        $this->db->select($selectStrList);
		$this->db->from($tableName);
		if(! is_null($whereArr)){
