...
$config['identity']                   = 'NRK';             /* You can use any unique column in your table as identity column.
...
$config['user_expire']                = 172800;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
/*
 ...
 | Please customize
 */
$config['session_hash'] = '9583d9ckus05998ecabb6f51b68wan2e44ea1236';
