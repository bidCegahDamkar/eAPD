                ...
                <div class="modal-body p-0">
                    ...
                    <div class="profileBox">
                        <div class="image-wrapper">
                            <img src="<?php echo base_url().$thumb_avatar ?>" alt="image" class="imaged rounded">
                        </div>
                        <div class="in">
                    ...
                    <ul class="listview flush transparent no-line image-listview">
                        ...
                        <li>
                            <?php
                            /*echo '
                            <a href="'.base_url().$controller.'/list_lapor_sewaktu" class="item">
...
<!-- * App Capsule -->
    ...
    <?
        if($this->uri->segment(2) == 'laporAPD'){
            echo '
                <script src="'.base_url().'assets/petugas/js/newLaporAPDver1.js"></script>
            ';
        }
