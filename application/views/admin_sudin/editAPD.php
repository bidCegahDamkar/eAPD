    <div class="page-content">
      ...
      <?php
      //d($masterAPD, $listKeberadaan, $listKondisi, $listUkuran, $dataAPD, FCPATH);
      ?>
                        ...
                        ?>
                            ...
                            <div class="row mt-2 mb-2 refi-kus hide-kus">
                                ...
                                <div class="col-10">
                                    ...
                                    <label class="custom-file-label" for="fileuploadInput"><?=$dataAPD['foto_apd'];?></label>
                                    <div class="valid-feedback">86</div>
                                    <div class="invalid-feedback">Harus diisi</div>
                                </div>
                            </div>
                            ...
                            <!-- preview image -->
                            <?php
                            $ada = base_url().'upload/petugas/APD/';
                            $tdkAda = base_url().'assets/img/master_apd/no-image.png';
                            $preview = (isset($dataAPD['foto_apd']) && !is_null(($dataAPD['foto_apd']))) ? $ada.$dataAPD['foto_apd'] : $tdkAda ;
